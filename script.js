...
const WIKI = (file) => `https://commons.wikimedia.org/wiki/Special:FilePath/${encodeURIComponent(file)}?width=200`;
...
<body>
  ...
  <p class="muted" style="margin-top:24px;">${t('धन्यवाद! Upaj Sahyog से खरीदारी के लिए शुक्रिया।','Thank you for shopping with Upaj Sahyog!')}</p>
</body>
</html>`;
...
function refreshStaticText(){
  ...
  document.getElementById('loginTitle').textContent = t('Upaj Sahyog में आपका स्वागत है','Welcome to Upaj Sahyog');
  ...
  document.getElementById('demoHint1').textContent = t('आधार OTP के लिए सहमति आवश्यक है','Demo: enter any name & 12 digits');
  ...
  document.getElementById('demoHint2').textContent = t('डेमो मोड OTP सर्वर द्वारा दिखाया जाएगा','Demo: enter any 4 digits');
  document.getElementById('skipBtn').textContent = t('अभी के लिए छोड़ें (गेस्ट मोड)','Skip for now (guest)');
